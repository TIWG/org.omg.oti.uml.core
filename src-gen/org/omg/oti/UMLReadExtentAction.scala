	...
	def readExtentAction_compositeMetaProperties: MetaPropertyFunctions = 
	  appendUnique(
		action_compositeMetaProperties,
		  Seq (MetaPropertyReference[UMLReadExtentAction[Uml], UMLOutputPin[Uml]]("result", _.result)) )
	...
	def readExtentAction_referenceMetaProperties: MetaPropertyFunctions = 
	  appendUnique(
		action_referenceMetaProperties,
		  Seq (MetaPropertyReference[UMLReadExtentAction[Uml], UMLClassifier[Uml]]("classifier", _.classifier)) )
