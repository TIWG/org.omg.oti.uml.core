	...
	def templateBinding_compositeMetaProperties: MetaPropertyFunctions = 
	  appendUnique(
		directedRelationship_compositeMetaProperties,
		  Seq (MetaPropertyCollection[UMLTemplateBinding[Uml], UMLTemplateParameterSubstitution[Uml]]("parameterSubstitution", _.parameterSubstitution)) )
	...
	def templateBinding_referenceMetaProperties: MetaPropertyFunctions = 
	  appendUnique(
		directedRelationship_referenceMetaProperties,
		  Seq (MetaPropertyReference[UMLTemplateBinding[Uml], UMLTemplateableElement[Uml]]("boundElement", _.boundElement),
		  	MetaPropertyReference[UMLTemplateBinding[Uml], UMLTemplateSignature[Uml]]("signature", _.signature)) )
