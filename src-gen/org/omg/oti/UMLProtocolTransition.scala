	...
	def protocolTransition_compositeMetaProperties: MetaPropertyFunctions = 
	  appendUnique(
		transition_compositeMetaProperties,
		  Seq (MetaPropertyReference[UMLProtocolTransition[Uml], UMLConstraint[Uml]]("postCondition", _.postCondition),
		  	MetaPropertyReference[UMLProtocolTransition[Uml], UMLConstraint[Uml]]("preCondition", _.preCondition)) )
